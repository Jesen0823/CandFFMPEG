/*播放视频音频,单线程，音视频非同步
 *clang -g -o player3 player3.c `pkg-config --cflags --libs sdl2` -I/usr/local/ffmpeg/include -L/usr/local/ffmpeg/lib -l avutil -l avformat -l avcodec -l swscale -l swresample
 ./player3 dongman30.mp4
 * */
#include <stdio.h>
#include <assert.h>
#include <SDL.h>
...
int main(int argc, char *argv[]){
    ...
    AVPicture   *pict = NULL; // save YUV data
    AVFrame    *pFrame = NULL;
    AVPacket    packet;
    int    frameFinished;
    ...
    // Register all formats and codecs,used to old ffmpeg version
    av_register_all();
    ...
    win = SDL_CreateWindow("Media Player v2.0",
